...
CATEGORIES_TREE = [
    {'name': 'الإسكان', 'emoji': '🏠', 'subs': [
        ('أسطوانات الغاز','🔥'), ('الإيجار','🏢'), ('الخدمات','💡'),
        ('الرهن العقاري','🏡'), ('الكهرباء','⚡'), ('المياه','💧'),
        ('صيانة المنزل','🔧'), ('ضرائب الممتلكات','📜'), ('مياه الصهريج','🚚'),
    ]},
    {'name': 'الأطفال والعائلة', 'emoji': '👨‍👩‍👧', 'subs': [
        ('أنشطة مدرسية','🏫'), ('تحويلات دعم عائلي','🤝'), ('رعاية الأطفال','🧸'),
        ('مستلزمات الأطفال','🍼'), ('مصروف','💰'),
    ]},
    {'name': 'الأعمال والعمل', 'emoji': '🧾', 'subs': [
        ('الإعلانات والتسويق','📢'), ('الخدمات القانونية','⚖️'),
        ('المحاسبة والضرائب','🗃️'), ('النطاقات والاستضافة','🌐'),
        ('تدريب ومؤتمرات','🎤'), ('تراخيص البرمجيات','🧩'),
        ('خدمات مهنية','🤝'), ('لوازم المكتب','📎'),
    ]},
    {'name': 'التأمين', 'emoji': '🛡️', 'subs': [
        ('تأمين الأجهزة','📱'), ('تأمين الحياة','❤️'), ('تأمين السفر','✈️'),
        ('تأمين السيارة','🚗'), ('تأمين المنزل','🏠'),
    ]},
    {'name': 'الترفيه', 'emoji': '🎭', 'subs': [
        ('استراحات ومزارع','🏕️'), ('الأفلام والبث','🎥'), ('الألعاب','🎮'),
        ('الحفلات والفعاليات','🎟️'), ('الرياضة واللياقة البدنية','🤸'),
        ('الكتب والمجلات','📚'), ('المدن الترفيهية والمعالم','🎡'),
        ('حجز الملاعب','⚽'),
    ]},
    {'name': 'التسوق', 'emoji': '🛍️', 'subs': [
        ('الأثاث','🛋️'), ('الأحذية والإكسسوارات','👟'), ('الألعاب','🧸'),
        ('الإلكترونيات','📱'), ('التسوق الإلكتروني','🛒'),
        ('الجمال والعناية الشخصية','💄'), ('العبايات والدشاديش','👘'),
        ('القرطاسية','✏️'), ('المجوهرات والساعات','💎'),
        ('المعدات الرياضية','🏀'), ('الملابس','👗'),
        ('المنزل والمطبخ','🔍'), ('الهدايا','🎁'), ('رسوم الشحن والتوصيل','📦'),
    ]},
    {'name': 'التعليم', 'emoji': '📚', 'subs': [
        ('الأنشطة اللامنهجية','🥇'), ('الدروس الخصوصية','📖'),
        ('الدورات عبر الإنترنت','💻'), ('الشهادات','⭐'),
        ('الكتب واللوازم','📚'), ('رسوم التعليم','🏫'),
    ]},
    {'name': 'الجهات الحكومية والرسوم', 'emoji': '🏛️', 'subs': [
        ('التأشيرات والإقامة','📋'), ('الجمارك والرسوم','📦'),
        ('السجل التجاري والتراخيص','📋'), ('تجديد الهوية/الجواز','🪪'),
        ('تصاريح العمل','🪪'), ('تصديق وتوثيق المستندات','✏️'),
        ('رخصة القيادة','🚦'), ('رسوم البلدية','📰'),
        ('رسوم قضائية وقانونية','⚖️'), ('مخالفات المرور','🚓'),
    ]},
    {'name': 'الحيوانات الأليفة', 'emoji': '🐾', 'subs': [
        ('الطب البيطري','🐶'), ('العناية بالحيوانات','✂️'),
        ('إيواء الحيوانات','🏠'), ('طعام الحيوانات','🦴'),
        ('مستلزمات الحيوانات','🧸'),
    ]},
    {'name': 'الخدمات الرقمية والاشتراكات', 'emoji': '📦', 'subs': [
        ('أدوات الذكاء الاصطناعي','🤖'), ('أدوات المطور','🧩'),
        ('اشتراكات أخرى','🧾'), ('اشتراكات الألعاب','🎮'),
        ('الإنترنت','🌐'), ('بث الموسيقى/الفيديو','📺'),
        ('تخزين سحابي','☁️'), ('تطبيقات الإنتاجية','✅'),
        ('خطة الجوال','📱'), ('في بي إن والأمان','🔒'),
        ('مشتريات داخل التطبيقات','📍'),
    ]},
    {'name': 'الزكاة والصدقات', 'emoji': '🤲', 'subs': [
        ('زكاة','🤲'), ('صدقة','🤝'), ('الكفارات','📿'), ('الأضحية','🐑'),
    ]},
    {'name': 'السفر', 'emoji': '✈️', 'subs': [
        ('الجولات والأنشطة','🗺️'), ('الحج والعمرة','🕋'),
        ('الرحلات الجوية','✈️'), ('الفنادق','🏨'),
        ('المطار والصالات','🛫'), ('باقات السفر','🏖️'),
        ('تأجير السيارات','🚗'), ('تأمين السفر','🛡️'),
        ('منتجعات وتذاكر يومية','🏖️'),
    ]},
    {'name': 'الصحة والعافية', 'emoji': '🩺', 'subs': [
        ('الأدوية','💊'), ('الأسنان','🦷'), ('البصريات والنظارات','👓'),
        ('التأمين الصحي','🛡️'), ('التطعيمات','💉'),
        ('الطب البديل (حجامة)','🌿'), ('العلاج','🛋️'),
        ('العلاج الطبيعي','🧴'), ('الفحوصات المخبرية','🧪'),
        ('الفيتامينات والمكملات','🌿'), ('المستشفى والعمليات','🏥'),
        ('زيارات الطبيب','🩺'),
    ]},
    {'name': 'الطعام وتناول الطعام', 'emoji': '🍽️', 'subs': [
        ('البقالة','🛒'), ('الطلبات الخارجية','🍕'), ('العصائر','🧃'),
        ('المخابز والحلويات','🎂'), ('المطاعم','🍽️'),
        ('المطاعم الفاخرة','🍷'), ('المقاهي والقهوة','☕'),
        ('الوجبات الخفيفة','🍪'), ('مياه معبأة','💧'),
    ]},
    {'name': 'العقارات', 'emoji': '🏘️', 'subs': [
        ('شراء عقار','🏠'), ('صيانة عقار','🔧'), ('رسوم وساطة','📋'),
    ]},
    {'name': 'العمالة المنزلية', 'emoji': '🧺', 'subs': [
        ('راتب العمالة','💵'), ('تذاكر وإقامة','✈️'), ('رسوم الاستقدام','📋'),
    ]},
    {'name': 'العناية الشخصية', 'emoji': '🧴', 'subs': [
        ('الحلاقة والتجميل','✂️'), ('العطور ومستحضرات','🧴'),
        ('النادي الرياضي','💪'), ('مستلزمات شخصية','🛁'),
    ]},
    {'name': 'المالية', 'emoji': '💰', 'subs': [
        ('أقساط قرض','💳'), ('رسوم بنكية','🏦'), ('استثمار','📈'),
        ('سداد ديون','💸'),
    ]},
    {'name': 'المركبات', 'emoji': '🚗', 'subs': [
        ('البترول والوقود','⛽'), ('تأمين السيارة','🛡️'),
        ('رسوم الطرق','🛣️'), ('فحص السيارة','🔍'),
    ]},
    {'name': 'المناسبات والاحتفالات', 'emoji': '🎊', 'subs': [
        ('أعراس وزواج','💍'), ('مواليد وعقيقة','👶'), ('تخرج','🎓'),
        ('ديكور وترتيب','🎀'), ('ضيافة','🍽️'),
    ]},
    {'name': 'المواصلات', 'emoji': '🚌', 'subs': [
        ('تاكسي وأوبر','🚕'), ('باص ومواصلات عامة','🚌'),
        ('ركوب مشترك','🚗'), ('تذاكر','🎫'),
    ]},
    {'name': 'النقد والصراف الآلي', 'emoji': '🏧', 'subs': [
        ('سحب نقدي','💵'), ('تحويل بنكي','🏦'), ('رسوم صراف','💳'),
    ]},
    {'name': 'الهوايات', 'emoji': '🎨', 'subs': [
        ('أدوات هوايات','🎨'), ('دورات هوايات','📖'),
        ('مستلزمات رياضية','⚽'), ('نوادي واشتراكات','🏅'),
    ]},
    {'name': 'خدمات المنزل', 'emoji': '🧰', 'subs': [
        ('الغسيل والتنظيف الجاف','🧺'), ('النقل والترحيل','📦'),
        ('أنظمة أمنية','🔔'), ('تنسيق حدائق','🌿'),
        ('تنظيف','🧹'), ('صيانة الأجهزة','🔧'), ('مكافحة الحشرات','✂️'),
    ]},
    {'name': 'عناية السيارة', 'emoji': '🚗', 'subs': [
        ('إكسسوارات','🧰'), ('الإطارات والعجلات','⚙️'),
        ('البطارية وتغيير الزيت','🟢'), ('التسجيل والفحص','🪪'),
        ('رسوم الطرق','🛣️'), ('غسيل السيارة','🚿'), ('قطع الغيار','⚙️'),
    ]},
    {'name': 'متفرقات', 'emoji': '🌀', 'subs': [
        ('التبرعات','🤝'), ('المشتريات المتنوعة','🛒'),
        ('النفقات الطائرة','❗'), ('أخرى','📦'),
    ]},
]
